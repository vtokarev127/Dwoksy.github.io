...
$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$(function(){function e(e,i){e.click(function(e){e.preventDefault(),$("body,html").animate({scrollTop:i.offset().top},450)})}var i=$(window).width(),t=$(".container").width(),a=$("#gallery img").length;$("#gallery").unitegallery;if($("#gallery").unitegallery({theme_load_panel:1!=a,theme_panel_position:i<769?"bottom":"right",thumb_width:i<769?139:175,thumb_height:i<769?93:120,slider_enable_text_panel:!1,gallery_width:1081,gallery_height:594,strip_space_between_thumbs:i<769?10:30,strip_control_avia:!1,strippanel_padding_top:0,strippanel_padding_bottom:0,strippanel_padding_left:i<769?0:8,strippanel_padding_right:i<769?0:8}),$(".popup-img").lightGallery({selector:"this",counter:!1,showAfterLoad:!1}),$(".popup-pdf").lightGallery({selector:"this",iframeMaxWidth:"95%",counter:!1,zoom:!1,showAfterLoad:!1}),$(".banner-articles-wrapper .bxslider").bxSlider({mode:"fade",controls:!1,oneToOneTouch:!0}),$(".banner-footer-carousel .bxslider").bxSlider({mode:"horizontal",maxSlides:i<481?1:i>480&&i<769?3:i>768&&i<993?5:6,infiniteLoop:!1,prevText:"",nextText:"",slideWidth:i<480?480:i>480&&i<769?t/3:i>768&&i<993?t/5:(t-100)/6,pagerType:"short",pagerShortSeparator:"/",pager:!(i<993)}),$(".reviews-audience-company-slider .bxslider").bxSlider({mode:"horizontal",maxSlides:i<481?1:i>480&&i<769?3:i>768&&i<993?5:6,infiniteLoop:!1,prevText:"",nextText:"",slideWidth:i<480?480:i>480&&i<769?t/3:i>768&&i<993?t/5:t/6,pagerType:"short",pagerShortSeparator:"/"}),$(".reviews-audience-text-slider .bxslider").bxSlider({mode:"horizontal",controls:i<993,infiniteLoop:!1,minSlides:1,maxSlides:2,prevText:"",nextText:"",slideWidth:i<993&&i>768?(t-65)/2:i<769?768:(t-100)/2,slideMargin:i<993?65:100}),$(".articles-audience .bxslider").bxSlider({mode:"horizontal",infiniteLoop:!1,minSlides:1,maxSlides:2,prevText:"",nextText:"",slideWidth:i<993&&i>768?(t-113)/2:i<769?768:475,slideMargin:113}),$(".photo-project-slider .bxslider").bxSlider({mode:"horizontal",infiniteLoop:!1,controls:!0,maxSlides:i<769&&i>480?2:i<481?1:3,prevText:"",nextText:"",slideWidth:i<993&&i>768?(t-27)/3:i<769&&i>480?(t-27)/2:i<481?480:(t-27)/3,pagerType:"short",pagerShortSeparator:"/",slideMargin:27}),$(".thumbnails a").click(function(e){e.preventDefault(),$(".player").each(function(){this.pause()})}),$(".bxslider").bxSlider({mode:"fade",captions:!0,slideWidth:700,prevText:"",nextText:""}),function(e){var i=0;$(e).each(function(e){$(this).height()>i&&(i=$(this).height())}),e.height(i)}($(".bxslider .item")),$(".main-menu-button").click(function(){$(".main-mobile-menu").slideToggle(),$(".main-menu-button").toggleClass("close")}),$(".audience-menu .arrow").click(function(e){e.preventDefault(),$(".audience-menu ul li").not(".arrow").slideToggle(),$(".audience-menu li.arrow").toggleClass("rotate")}),$(".callback").submit(function(){var e=this;return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(".callback-wrapper").eq($(".callback-wrapper .callback").index(e)).fadeOut(250);var i=$(".callback_done").eq($(".callback-wrapper .callback").index(e));setTimeout(function(){i.fadeIn(250)},250),setTimeout(function(){},1e3)}),!1}),$(".return-form").click(function(e){e.preventDefault(),$(".callback_done").fadeOut(250),setTimeout(function(){$(".callback-wrapper").fadeIn(250)},250)}),$("*").is(".audience-menu"))var l=+$(".audience-menu").offset().top;$(window).scroll(function(){$(this).scrollTop()>=l?($(".audience-menu").addClass("sticky"),$(".header-top-line").addClass("margin")):($(".audience-menu").removeClass("sticky"),$(".header-top-line").removeClass("margin"))}),e($('.main-navigation a[href="#reviews"]'),$(".banner-footer")),e($('.main-navigation a[href="#project"]'),$(".our-project .our-project-title")),$(".btn-pulse").on("click",function(){var e=$(this);e.removeClass("circle-pulse"),setTimeout(function(){e.addClass("circle-pulse")},1),e.closest("li").siblings("li").find(".btn-pulse").removeClass("circle-pulse")})});